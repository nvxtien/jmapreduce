...
describe('should return words key value', function () {
    it('words key value', function (done) {
        var jmapReduce = new JMapReduce();
        ...
        expect(diff(jmapReduce.collect()[0], {
            key: 'group1',
            value: [{key: 'group1', value: 1}, {key: 'group1', value: 1}]
        }))
            .to.equal(false);
